...
REM
REM Generated by Vivado on Wed Dec 22 16:46:23 +0800 2021
...
call xsim  lab1_tb_time_impl -key {Post-Implementation:sim_1:Timing:lab1_tb} -tclbatch lab1_tb.tcl -log simulate.log
